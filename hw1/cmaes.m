function [BestSol] = cmaes(CostFunction, x0, lb, ub)
%
...
VarSize=size(x0);       % Decision Variables Matrix Size

nVar=10;                % Number of Unknown (Decision) Variables

VarMin=lb(1);             % Lower Bound of Decision Variables
VarMax=ub(1);            % Upper Bound of Decision Variables
